...
//        if (flMain!=null)
        ((ViewGroup)viewById).addView(emptyView);
    }
    ...
    public void removeEmptyView() {
        ...
        View viewById = getWindow().getDecorView();
        if (emptyView != null)
            ((ViewGroup)viewById).removeView(emptyView);
...
//        if (flMain!=null)
            ((ViewGroup)viewById).addView(lodingView);
    }
    ...
    public void removeLodingView() {
        ...
        FrameLayout flMain = (FrameLayout) viewById.findViewById(R.id.fl_main);
        if (lodingView != null) {
            ((ViewGroup)viewById).removeView(lodingView);
